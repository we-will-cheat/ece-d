...
function odd()
{
    ...
    if(dev=="pc"){
        document.getElementById("odd").style.backgroundColor="rgba(255, 0, 8, 0.8)";
        document.getElementById("odd").style.color="black";
        document.getElementById("odd").style.borderColor="black";
    document.getElementById("done").style.backgroundColor="rgba(255, 0, 8, 0.8)";
    document.getElementById("done").style.color="black";
    document.getElementById("done").style.borderColor="black";
    document.getElementById("even").style.backgroundColor="rgba(0,0,0,0.8)";
    document.getElementById("even").style.color="white";
    }
    flag="odd";
}
...
function even()
{
    ...
    if(dev=="pc"){
        document.getElementById("even").style.backgroundColor="rgba(2, 2, 255, 0.8)";
        document.getElementById("even").style.color="black";
        document.getElementById("even").style.borderColor="black";
    document.getElementById("done").style.backgroundColor="rgba(2, 2, 255, 0.8)";
    document.getElementById("done").style.color="black";
    document.getElementById("done").style.borderColor="black";
    document.getElementById("odd").style.backgroundColor="rgba(0,0,0,0.8)";
